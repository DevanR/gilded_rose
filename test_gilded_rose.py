...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_quality_degrades_twice_past_sell_in_date(self):
        items = [Item("foo", 2, 10)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(9, items[0].quality)
    ...
    def test_quality_increases_twice_ten_to_six(self):
    ...
    def test_quality_increases_thrice_five_to_1(self):
    ...
    def test_quality_zeros_at_sell_in(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 0, 20)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(0, items[0].quality)

    def test_quality_stays_zero_past_sell_in(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 0, 20)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        gilded_rose.update_quality()
